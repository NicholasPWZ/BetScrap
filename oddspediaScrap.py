...
def odds_basketball():
    ...
    for i in lista_urls:
        ...
        def calc_stake(odd1, odd2, stake):
            ...
            return f'Stake na odd {odd1} X {stake_odd1} = {odd1 * stake_odd1} Stake na odd {odd2} X {stake_odd2} = {odd2 * stake_odd2}'
        results.append(f'{partida} {casa1maior} {odd1maior} {casa2maior} {odd2maior} = {calc_profit_percent(odd1maior, odd2maior)} % {calc_stake(odd1maior, odd2maior, stake)}') 
    return results
...
def odds_football():
    ...
    for i in lista_urls:
        ...
        def calc_stake(odd1, oddtie, odd2, stake):
            ...
            return f'Stake na odd {odd1} X {stake_odd1} = {odd1 * stake_odd1} Stake na odd {oddtie} X {stake_oddtie} = {oddtie * stake_oddtie} Stake na odd {odd2} X {stake_odd2} = {odd2 * stake_odd2}'   
        
        results.append(f'{partida}  {casa1maior} ->  {odd1maior} {casatiemaior} -> {oddtiemaior} {casa2maior} -> {odd2maior} = {calc_stake(odd1maior, oddtiemaior, odd2maior, stake)}')    
    return results
